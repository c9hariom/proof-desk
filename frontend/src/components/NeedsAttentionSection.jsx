  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {items.map((item, i) => {
        ...
        return (
          <div key={i} className={`flex items-start gap-3 rounded-xl border p-3 ${colors.bg} ${colors.border}`}>
            <span className={`text-[10px] font-bold uppercase tracking-widest ${colors.text} flex-shrink-0 mt-0.5`}>
              {item.severity}
            </span>
            <div>
